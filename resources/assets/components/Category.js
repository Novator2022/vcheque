        ...
        return editing
            ?<Item>
                <Item.Content>
                    ...
                    <Item.Description>
                        <Form>
                            <Form.Input name="name" label={trans('messages.categories.name')} onChange={this.handleFieldChange} defaultValue={item.name}/>
                        </Form>
                    </Item.Description>
                    <Item.Extra>
                        <Menu secondary stackable borderless>
                            <Menu.Menu position="right">
                                ...
                                <Menu.Item>
                                    <Button color="green" icon  onClick={this.updateCategory}><Icon name="pencil"/>{trans('messages.save')}</Button>
                                </Menu.Item>
                                <Menu.Item>
                                    <Button color="red" icon onClick={this.removeCategory}><Icon name="x"/>{trans('messages.remove')}</Button>
                                </Menu.Item>
                            </Menu.Menu>
                        </Menu>
                    </Item.Extra>
                ...
                <Table.Cell textAlign="right">
                    { item.deleted_at
                        ...
                        :<Button.Group size="mini">
                            ...
                            <Button color="red" icon onClick={this.removeCategory}><Icon name="x"/>{trans('messages.deactivate')}</Button>
                        </Button.Group>
                    }
                </Table.Cell>
            </Table.Row>
